...
func Test_login1(t *testing.T) {
	...
	tests := []struct {
		...
		{"400 request", anotherData, 200, user1},
...
func Test_loginStatusCode(t *testing.T) {
	// r := login()
	...
	tests := []struct {
		...
		{"400 request", anotherData, 200, user2},
		{"200 request", correctData, 200, user2},
		// {"400 request wrong payload", wrongData, 400, user1},
	}
	for _, tt := range tests {
...
func Test_getLocalities(t *testing.T) {
	...
	tests := []struct {
		...
		//state->city->locality->admin->neighborhood
		{"get all states for agent", "?agent=2", 400},
		...
		{"get neighborhood from admin", "?agent=2&state=1&city=2&admin=1&locality=1", 400},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
//auditorBakeries
func Test_auditorBakeries(t *testing.T) {

	ts := httptest.NewServer(http.HandlerFunc(auditorBakeries))
...
func Test_agentBakeries(t *testing.T) {
	...
	tests := []struct {
		...
		{"get agent FULL QUERY with AGENT=10", "?agent=10&state=1&city=2&admin=1&locality=1&neighborhood=1", 2000},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
